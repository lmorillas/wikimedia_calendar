...
def event_to_item(event, cal=None):
...
if __name__ == '__main__':
    ...
    cal_id = 'atinet.es_8as8kj0nsu2ipbfei1lckmpgc8@group.calendar.google.com'

    items = []

    service = connect_calendar()
    events = calendar_events(service, cal_id, singleEvents="True")

    for event in events:
        items.append(event_to_item(event, 'ATI' ))
    ...
    json.dump(data, open('events_swlibre.json', 'w'))
